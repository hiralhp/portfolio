...
export default function About() {
  return (
    <section id="about" className="py-28 sm:py-36 bg-zinc-950 border-t border-white/[0.04]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-[1fr_1.5fr] gap-16 items-start">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-50 mb-10 leading-tight">
              A bit about <br />
              {NAME}
            </h2>
            ...
            <div className="space-y-4">
              {highlights.map(({ label, value }) => (
                <div key={label} className="flex gap-6">
                  <span className="text-xs font-medium text-zinc-600 uppercase tracking-wider w-20 shrink-0 pt-0.5">
                    {label}
                  </span>
          ...
          >
            {BIO_LINES.map((line, i) => (
              <p key={i} className="text-base text-zinc-400 leading-[1.75]">
                {line}
              </p>
            ))}
            ...
            <div className="pt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tech}
                    className="px-3 py-1.5 text-xs font-medium text-zinc-400 border border-white/[0.07] rounded-lg bg-white/[0.03]"
                  >
                    {tech}
                  </span>
                ))}
